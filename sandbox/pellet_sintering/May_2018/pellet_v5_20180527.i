...
[Functions]
  ...
  [./temp-time_punch]
    ...
    data_file = temp-vs-time_punch.csv
  [../]

  [./temp-time_die-top]
    type = PiecewiseLinear
    data_file = temp-vs-time_die-top.csv
  [../]
...
[BCs]
  ...
  [./punch_temp]
    ...
    variable = temp
    boundary = 'upper_punch_top lower_punch_bottom upper_punch_outer_no-contact lower_punch_outer_no-contact'
